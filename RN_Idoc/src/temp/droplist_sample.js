...
export default class Demo extends Component {
  ...
  render() {
    let dropdown_6_icon = this.state.dropdown_6_icon_heart ? require('../../assets/images/avatarCard.png') : require('../../assets/images/avatarLock.png')
    return (
  ...
  _dropdown_2_renderRow(rowData, rowID, highlighted) {
    let icon = highlighted ? require('../../assets/images/avatarCard.png') : require('../../assets/images/avatarLock.png')
    let evenRow = rowID % 2;
    return (
